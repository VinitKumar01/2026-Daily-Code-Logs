# 2026-Daily-Code-Logs

### This repo contains logs of what i did each day of 2026 related to coding only
...
03-01-2026 || Learnt about tokenization, vector embeddings, transformers etc. also coded a basic tokenizer in python.

04-01-2026 || Revised trees and graphs in dsa for exam.
...
21-01-2026 || Mapped out the architecture of Node registry for n8n-clone project.
...
02-03-2026 || Read chapter 2 of the book A common-sense guide for data-structures and algorithms.
...
24-05-2026 || Learnt more bash scripting -> pipe status with multiple commands, timing commands, sourcing scripts, etc.

25-05-2026 || Learnt more bash scripting -> curly braces vs parentheses for functions, return vs output, parameter expansion, etc.
